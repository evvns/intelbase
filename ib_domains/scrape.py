# submodule template testing for intelbase. this should rely on certain components and pre-declared components of intelbase.
# scrapes domains for external info about an owner with zoomeye.
import requests
import json
import sys
